...
def get_kitti_dataloader(config):
    ...
    DATASETS_CONFIG = {
        ...
        "filenames_file": "../dataset/kitti/train_test_inputs/kitti_eigen_train_files_with_gt.txt",
        "input_height": 352,
        ...
        "filenames_file_eval": "../dataset/kitti/train_test_inputs/kitti_eigen_test_files_with_gt.txt",
        "min_depth_eval": 1e-3,
        "max_depth_eval": 80,
